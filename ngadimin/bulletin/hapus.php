  ...
  <table width="100" border="0" cellpadding="0">
    ...
    <tr>
      <td width="206" align="center" valign="top" bgcolor="#000099"><table width="206" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
         <tr>
          <td bgcolor="#00006A"><a href="berita.php"><span class="style1">- Upload</span></a></td>
        </tr>
        <tr>
      ...
      <td width="753" height="250" align="left" bgcolor="#FFFFFF"><div align="center">INPUT  Data
        ...
        <tr>
          <td width="127">
			...
			$query = "SELECT * FROM buletin WHERE id = '$id'";
			$hasil = mysqli_query($koneksi,$query);
			$data = mysqli_fetch_array($hasil);
			$namaFile = $data['name'];

			$query = "DELETE FROM buletin WHERE id = $id";
...
<a href="buletin.php">Kembali ke Formupload</a><br>
