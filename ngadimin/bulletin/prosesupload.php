...
<td bgcolor="#000048"><span class="style1"><a href="#"onClick="logout()"><strong>- Logout</strong></a></span></td>
      ...
      <td width="753" height="250" align="left" bgcolor="#FFFFFF"><div align="center">INPUT  Buletin
        </div>
...
if($fileSize > 0|| $fileError == 0){ 
	...
	if($move){
		...
		echo "<button><a href='buletin.php'>Form daftar Upload</a></button>";

		$q = "INSERT into buletin (name, size, type, lokasi) VALUES ('$fileName', '$fileSize', '$fileType','data/$fileName')";
		$result = mysqli_query($koneksi,$q);

		$q1 = "SELECT lokasi from buletin where name = '$fileName' limit 1 ";
