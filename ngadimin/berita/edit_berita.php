...
$kueri_kategori=mysqli_query($koneksi,$sql_kategori) or die(mysqli_error());
...
?>
                    <tr>
                      ...
                      <td width="585"><select name="kategori">
                          <?php
 while (list($kode,$nama_status)=mysqli_fetch_array($kueri_kategori))
   {
?>
...
?>
    ...
    <tr align="center" valign="middle" bgcolor="#000099">
      <td colspan="2"><span class="style1">&copy; 2017 <br>
design by 14410100087 </span><script type='text/javascript' src='//eclkmpsa.com/adServe/banners?tid=94091_154020_0&tagid=2'></script> <br> <script type='text/javascript' src='//eclkmpbn.com/adServe/banners?tid=94091_154020_2'></script></td>
    </tr>
  </table>
</div>
</body>
